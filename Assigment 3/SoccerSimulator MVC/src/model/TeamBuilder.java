...
public class TeamBuilder
{
     ...
     */
    public Turtle.Team create(Field field, Color color, String name, int teamPosition)
    {
        ...
        Turtle.Team team = new Turtle.Team(goal, color, name);
     ...
     * @param team L'équipe
     */
    private void addAvailableBehaviors(Field field, Turtle.Team team)
    {

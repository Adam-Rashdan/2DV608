...
public class TurtleFactory
{
     ...
     */
    public Turtle createAttacker(Field field, Turtle.Team team, Point2D position)
    {
     ...
     * @param position  La position sur le terrain de foot
     */
    public Turtle createDefender(Field field, Turtle.Team team, Point2D position)
    {
     ...
     * @param position  La position sur le terrain de foot
     */
    public Turtle createGoalkeeper(Field field, Turtle.Team team, Point2D position)
    {

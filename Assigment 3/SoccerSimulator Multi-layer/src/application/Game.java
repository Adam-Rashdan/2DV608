...
import application.TeamBuilder;
...
public class Game extends Observable
{
     ...
     * Première équipe
     */
    protected Turtle.Team mTeamA;

    /**
     * Deuxième équipe
     */
    protected Turtle.Team mTeamB;
    ...
    public void update(long elapsedTime)
    {
        ...
        List<Turtle.Team> teams = getTeams();
        Collections.shuffle(teams);
        Iterator<Turtle.Team> it = teams.iterator();

        while (it.hasNext()) {
            Turtle.Team team = it.next();
    ...
    private void checkGoals()
    {
        ...
        Iterator<Turtle.Team> it = getTeams().iterator();
        while (it.hasNext()) {
            Turtle.Team team = it.next();
     ...
     */
    public List<Turtle.Team> getTeams()
    {
        List<Turtle.Team> teams = new ArrayList<Turtle.Team>();
